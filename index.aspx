      ...
      <div class="container">
        <div class="navbar-header">
          <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
            ...
            <h1><img src="assets/img/icon-vaccine.png" height="15%" width="15%" /><a href="#">TEEKA</a></h1>
        </div>
	...
	<div id="headerwrap">
		<div class="container">
			<div class="row centered">
				...
				<h3 align="left">we provide vaccine information and offer vaccine notifications</h3-->
				</div>
			</div><!-- row -->
		</div><!-- container -->
	</div><!-- headerwrap -->
	...
	<div id="dg">
		<div class="container">
			<div class="row centered">
				...
				<div class="col-lg-4">
					<div class="tilt">
					<a href="#"><img src="assets/img/icon-vaccine.png" alt=""></a>
				...
				<div class="col-lg-4">
					<div class="tilt">
					<a href="#"><img src="assets/img/mail_icon.png" alt=""></a>
